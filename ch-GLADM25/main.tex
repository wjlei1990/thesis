...
\begin{figure}[ht!] 
  ...
  \caption{\small{Map views of compressional wavespeed variations beneath South America for GLAD-M25~(first column) and global models S362ANI$+$M~\cite{moulik2014anisotropic} (second column), LLNL-G3Dv3~\cite{simmons2012llnl} (third column), and GAP-P4~\cite{fukao2013subducted} (fourth column).}}

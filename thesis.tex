...
\title{Building the second generation of global adjoint tomographic model GLAD-M25}

\submitted{Feb 2019}  % degree conferral date (January, April, June, September, or November)
...
\include{ch-asdf/ASDF_chapter}
\include{ch-workflow/00_global_tomo_chapter}
\include{ch-weighting/weighting}
\include{ch-GLADM25/main}

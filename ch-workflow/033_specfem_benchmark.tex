...
\begin{figure}[htb!]
  ...
  \includegraphics[width=0.8\textwidth]{ch-workflow/figures/s480}
	\caption{Strong scaling for the spherically symmetric PREM Earth model on Titan for a minimum seismic
...
\begin{figure}[htb!]
  ...
  \includegraphics[width=0.8\textwidth]{ch-workflow/figures/weak}
	\caption{Weak scaling for the PREM Earth model on Titan. Performance is measured
...
\begin{table}[]
\centering
\tabletitle{Comparison of processing time per time step with and without full 
...
\begin{table}[]
\centering
\tabletitle{Comparison of processing time per time step with and without
...
\begin{figure}[htb!]
  ...
  \includegraphics[width=0.8\textwidth]{ch-workflow/figures/s160nounq}
	\caption{Strong scaling for the PREM model on Titan for a minimum seismic
